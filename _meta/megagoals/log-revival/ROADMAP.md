...
- [ ] 08-permalink-fix, a post resolves at a clean canonical slug instead of the redundant `/blog/log/`; permalink declared in `hugo.yaml`, `auto`, PR #9 (added 2026-06-28, Han)
